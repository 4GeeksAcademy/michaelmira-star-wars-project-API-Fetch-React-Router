      ...
      <div className="card border border-0">
        <div className="row text-center">
          <div className="col-md-6 text-center">
            <img
              src={BACKEND_URL + params.uid + ".jpg"}
          ...
          <div className="col-md-6">
            <div className="card-body text-center">
              ...
              <h3 className="card-text display-5">
                Diameter : {detail?.diameter}
              </h3>
              <h3 className="card-text display-5">
                Rotation Period : {detail?.rotation_period}
              </h3>
              <h3 className="card-text display-5">
                Orbital Period : {detail?.orbital_period}
              </h3>
              <h3 className="card-text display-5">
              ...
              <button
                ...
                onClick={() => {
                  let isOnTheList = store.favorites.find(
                    (item) =>
                      item.name == detail.name && item.category == "planets"
                  );
                  if (isOnTheList) {
